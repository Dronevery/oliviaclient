...
namespace MavLinkNet
{
	...
	public class UasSysStatus: UasMessage
	{
		...
		public MavSysStatusSensor OnboardControlSensorsPresent {
			...
			set {
				mOnboardControlSensorsPresent = value;
				NotifyUpdated ();
			}
		}
		...
		public MavSysStatusSensor OnboardControlSensorsEnabled {
			...
			set {
				mOnboardControlSensorsEnabled = value;
				NotifyUpdated ();
			}
		}
		...
		public MavSysStatusSensor OnboardControlSensorsHealth {
			...
			set {
				mOnboardControlSensorsHealth = value;
				NotifyUpdated ();
			}
		}
	...
	public class UasParamMapRc: UasMessage
	{
		...
		public byte ParameterRcChannelIndex {
			...
			set {
				mParameterRcChannelIndex = value;
				NotifyUpdated ();
			}
		}
	...
	public class UasAutopilotVersion: UasMessage
	{
		...
		public byte[] MiddlewareCustomVersion {
			...
			set {
				mMiddlewareCustomVersion = value;
				NotifyUpdated ();
			}
		}
	...
	public class UasSummary
	{
		public static UasMessage CreateFromId (byte id)
		{
			...
			case 1:
				return new UasSysStatus ();
			case 2:
				return new UasSystemTime ();
			case 4:
				return new UasPing ();
			case 5:
				return new UasChangeOperatorControl ();
			case 6:
				return new UasChangeOperatorControlAck ();
			case 7:
				return new UasAuthKey ();
			case 11:
				return new UasSetMode ();
			case 20:
				return new UasParamRequestRead ();
			case 21:
				return new UasParamRequestList ();
			case 22:
				return new UasParamValue ();
			case 23:
				return new UasParamSet ();
			case 24:
				return new UasGpsRawInt ();
			case 25:
				return new UasGpsStatus ();
			case 26:
				return new UasScaledImu ();
			case 27:
				return new UasRawImu ();
			case 28:
				return new UasRawPressure ();
			case 29:
				return new UasScaledPressure ();
			case 30:
				return new UasAttitude ();
			case 31:
				return new UasAttitudeQuaternion ();
			case 32:
				return new UasLocalPositionNed ();
			case 33:
				return new UasGlobalPositionInt ();
			case 34:
				return new UasRcChannelsScaled ();
			case 35:
				return new UasRcChannelsRaw ();
			case 36:
				return new UasServoOutputRaw ();
			case 37:
				return new UasMissionRequestPartialList ();
			case 38:
				return new UasMissionWritePartialList ();
			case 39:
				return new UasMissionItem ();
			case 40:
				return new UasMissionRequest ();
			case 41:
				return new UasMissionSetCurrent ();
			case 42:
				return new UasMissionCurrent ();
			case 43:
				return new UasMissionRequestList ();
			case 44:
				return new UasMissionCount ();
			case 45:
				return new UasMissionClearAll ();
			case 46:
				return new UasMissionItemReached ();
			case 47:
				return new UasMissionAck ();
			case 48:
				return new UasSetGpsGlobalOrigin ();
			case 49:
				return new UasGpsGlobalOrigin ();
			case 50:
				return new UasParamMapRc ();
			case 54:
				return new UasSafetySetAllowedArea ();
			case 55:
				return new UasSafetyAllowedArea ();
			case 61:
				return new UasAttitudeQuaternionCov ();
			case 62:
				return new UasNavControllerOutput ();
			case 63:
				return new UasGlobalPositionIntCov ();
			case 64:
				return new UasLocalPositionNedCov ();
			case 65:
				return new UasRcChannels ();
			case 66:
				return new UasRequestDataStream ();
			case 67:
				return new UasDataStream ();
			case 69:
				return new UasManualControl ();
			case 70:
				return new UasRcChannelsOverride ();
			case 73:
				return new UasMissionItemInt ();
			case 74:
				return new UasVfrHud ();
			case 75:
				return new UasCommandInt ();
			case 76:
				return new UasCommandLong ();
			case 77:
				return new UasCommandAck ();
			case 81:
				return new UasManualSetpoint ();
			case 82:
				return new UasSetAttitudeTarget ();
			case 83:
				return new UasAttitudeTarget ();
			case 84:
				return new UasSetPositionTargetLocalNed ();
			case 85:
				return new UasPositionTargetLocalNed ();
			case 86:
				return new UasSetPositionTargetGlobalInt ();
			case 87:
				return new UasPositionTargetGlobalInt ();
			case 89:
				return new UasLocalPositionNedSystemGlobalOffset ();
			case 90:
				return new UasHilState ();
			case 91:
				return new UasHilControls ();
			case 92:
				return new UasHilRcInputsRaw ();
			case 100:
				return new UasOpticalFlow ();
			case 101:
				return new UasGlobalVisionPositionEstimate ();
			case 102:
				return new UasVisionPositionEstimate ();
			case 103:
				return new UasVisionSpeedEstimate ();
			case 104:
				return new UasViconPositionEstimate ();
			case 105:
				return new UasHighresImu ();
			case 106:
				return new UasOpticalFlowRad ();
			case 107:
				return new UasHilSensor ();
			case 108:
				return new UasSimState ();
			case 109:
				return new UasRadioStatus ();
			case 110:
				return new UasFileTransferProtocol ();
			case 111:
				return new UasTimesync ();
			case 113:
				return new UasHilGps ();
			case 114:
				return new UasHilOpticalFlow ();
			case 115:
				return new UasHilStateQuaternion ();
			case 116:
				return new UasScaledImu2 ();
			case 117:
				return new UasLogRequestList ();
			case 118:
				return new UasLogEntry ();
			case 119:
				return new UasLogRequestData ();
			case 120:
				return new UasLogData ();
			case 121:
				return new UasLogErase ();
			case 122:
				return new UasLogRequestEnd ();
			case 123:
				return new UasGpsInjectData ();
			case 124:
				return new UasGps2Raw ();
			case 125:
				return new UasPowerStatus ();
			case 126:
				return new UasSerialControl ();
			case 127:
				return new UasGpsRtk ();
			case 128:
				return new UasGps2Rtk ();
			case 129:
				return new UasScaledImu3 ();
			case 130:
				return new UasDataTransmissionHandshake ();
			case 131:
				return new UasEncapsulatedData ();
			case 132:
				return new UasDistanceSensor ();
			case 133:
				return new UasTerrainRequest ();
			case 134:
				return new UasTerrainData ();
			case 135:
				return new UasTerrainCheck ();
			case 136:
				return new UasTerrainReport ();
			case 137:
				return new UasScaledPressure2 ();
			case 138:
				return new UasAttPosMocap ();
			case 139:
				return new UasSetActuatorControlTarget ();
			case 140:
				return new UasActuatorControlTarget ();
			case 147:
				return new UasBatteryStatus ();
			case 148:
				return new UasAutopilotVersion ();
			case 248:
				return new UasV2Extension ();
			case 249:
				return new UasMemoryVect ();
			case 250:
				return new UasDebugVect ();
			case 251:
				return new UasNamedValueFloat ();
			case 252:
				return new UasNamedValueInt ();
			case 253:
				return new UasStatustext ();
			case 254:
				return new UasDebug ();
			default:
				return null;
