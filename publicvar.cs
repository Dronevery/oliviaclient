...
// "127.0.0.1:8000";
	...
	public static int basei = 7213;
	// the i of the tile in the Point (0,0,0) // not in use
	public static int basej = 3066;
	// not in use
...
//*Mathf.Pow(2,17-zoom);// the size of one tile in Unity world
	...
	// basei-maxTileX < i < basei+maxTileX will be loaded
	public static int maxTileY = loadwidth;

	public static int heightmapres = 33;
	// the resolution of heightmap (must be 2^n+1)
	public static float maxHeight = 5000;
	// the height of the terrain box



	public static bool isloadfromLonLat = false;
	// not in use
	public static float longitude = 137f;
	// not in use
	//117.2688041888f;
